...
<html lang="en" data-bs-theme="light"><head><script src="/docs/5.3/assets/js/color-modes.js"></script><style id="yt-extension-style">.ad-container,
  .ad-div,
  .masthead-ad-control,
 .video-ads,
...
<meta name="theme-color" content="#712cf9">
  ...
  <style id="yt-extension-info">.yt-ext-hidden { display: none; } #yt-ext-info-bar { position: fixed; bottom: 20px; left: 20px; height: auto; border: 1px solid #ececec; background: #03a9f4; z-index: 100000; padding: 5px 12px; color: white; font-size: 14px; border-radius: 4px; }</style></head>
...
<div id="yt-ext-info-bar" class="yt-ext-hidden">Skipping ads...</div></body></html>